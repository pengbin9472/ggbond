...
import (
	...
	adminhandler "github.com/pengbin9472/ggbond/internal/handler/admin"
		...
		},
		{
			...
			setup: func(t *testing.T, deps *contractDeps) {
				...
				deps.settingRepo.SetAll(map[string]string{
					...
					service.SettingKeySMTPFromName: "GGbond",
					...
					service.SettingKeySiteName:     "GGbond",
