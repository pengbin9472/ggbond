...
import (
	...
	"github.com/pengbin9472/ggbond/ent/migrate"
...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.Proxy, c.RedeemCode, c.ReferralReward, c.SecuritySecret, c.Setting,
...
type (
	hooks struct {
		...
		ReferralReward, SecuritySecret, Setting, SubscriptionPlan,
