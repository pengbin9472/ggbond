        ...
        <div class="card">
          <div class="border-b border-gray-100 px-6 py-4 dark:border-dark-700">
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
              ...
              <a :href="locale === 'zh' ? 'https://github.com/pengbin9472/ggbond/blob/main/docs/PAYMENT_CN.md' : 'https://github.com/pengbin9472/ggbond/blob/main/docs/PAYMENT.md'" target="_blank" rel="noopener noreferrer" class="ml-2 inline-flex items-center text-primary-600 hover:text-primary-700 dark:text-primary-400 dark:hover:text-primary-300">
            ...
            <template v-if="form.payment_enabled">
              ...
              <div>
                ...
                <p class="mt-2 text-xs text-gray-400 dark:text-gray-500">
                  ...
                  <a :href="locale === 'zh' ? 'https://github.com/pengbin9472/ggbond/blob/main/docs/PAYMENT_CN.md#%E6%94%AF%E6%8C%81%E7%9A%84%E6%94%AF%E4%BB%98%E6%96%B9%E5%BC%8F' : 'https://github.com/pengbin9472/ggbond/blob/main/docs/PAYMENT.md#supported-payment-methods'" target="_blank" rel="noopener noreferrer" class="ml-1 text-primary-500 hover:text-primary-600 dark:text-primary-400 dark:hover:text-primary-300">
