...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	userHandler := handler.NewUserHandler(userService, adminService, billingService)
