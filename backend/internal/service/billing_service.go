...
func (s *BillingService) initFallbackPricing() {
	...
	s.fallbackPrices["gemini-3.1-flash-image"] = &ModelPricing{
		InputPricePerToken:       2e-6,   // $2 per MTok
		OutputPricePerToken:      12e-6,  // $12 per MTok
		ImageOutputPricePerToken: 120e-6, // $120 per MTok
		SupportsCacheBreakdown:   false,
	}
...
func (s *BillingService) getFallbackPricing(model string) *ModelPricing {
	...
	if strings.Contains(modelLower, "gemini-3.1-flash-image") ||
		strings.Contains(modelLower, "gemini-3-1-flash-image") ||
		strings.Contains(modelLower, "gemini-3-pro-image") {
		return s.fallbackPrices["gemini-3.1-flash-image"]
	}
