#!/bin/bash
#
# GGbond Installation Script (Test Branch)
# GGbond 安装脚本（测试分支）
...
declare -A MSG_EN=(
    ...
    # Installation
    ["install_title"]="GGbond Installation Script (Test)"
...
download_and_extract() {
    local archive_name="ggbond_test_${OS}_${ARCH}.tar.gz"
