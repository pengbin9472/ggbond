...
const runtimeLevelOptions = computed<SelectOption[]>(() => [
...
const runtimeStacktraceLevelOptions = computed<SelectOption[]>(() => [
...
const logLevelFilterOptions = computed<SelectOption[]>(() => [
  { value: '', label: '全部' },
  { value: 'debug', label: 'debug' },
  { value: 'info', label: 'info' },
  { value: 'warn', label: 'warn' },
  ...
  <section class="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm dark:border-dark-700 dark:bg-dark-900/60">
    ...
    <div class="mb-4 rounded-xl border border-gray-200 bg-gray-50 p-3 dark:border-dark-700 dark:bg-dark-800/70">
      ...
      <div class="grid grid-cols-1 gap-3 md:grid-cols-2 xl:grid-cols-6">
        ...
        <label class="text-xs text-gray-600 dark:text-gray-300">
          堆栈阈值
          <Select v-model="runtimeConfig.stacktrace_level" class="mt-1" :options="runtimeStacktraceLevelOptions" />
        </label>
        <label class="text-xs text-gray-600 dark:text-gray-300">
          采样初始
    ...
    <div class="mb-4 grid grid-cols-1 gap-3 md:grid-cols-5">
      ...
      <label class="text-xs text-gray-600 dark:text-gray-300">
        级别
        <Select v-model="filters.level" class="mt-1" :options="logLevelFilterOptions" />
      </label>
      <label class="text-xs text-gray-600 dark:text-gray-300">
        组件
