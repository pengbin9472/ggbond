...
var upgrader = websocket.Upgrader{
	...
	// - The frontend passes ["ggbond-admin", "jwt.<token>"].
	// - We always select "ggbond-admin" so the token is never echoed back in the handshake response.
	Subprotocols: []string{"ggbond-admin"},
}
