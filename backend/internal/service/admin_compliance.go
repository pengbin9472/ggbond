...
const (
	...
	AdminComplianceDocumentURLZH  = "https://github.com/pengbin9472/ggbond/blob/main/docs/legal/admin-compliance.zh.md"
	AdminComplianceDocumentURLEN  = "https://github.com/pengbin9472/ggbond/blob/main/docs/legal/admin-compliance.en.md"
