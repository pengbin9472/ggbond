          ...
          <div class="card">
            ...
            <div class="space-y-5 p-6">
              ...
              >
                ...
                <div
                  v-if="form.referral_reward_type === 'percentage'"
                  class="mb-4"
                >
                  <label
                    class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
          ...
          <div class="card">
            ...
            <div class="space-y-6 p-6">
              ...
              <div class="flex items-center gap-2 text-sm">
                ...
                <a
                  href="https://raw.githubusercontent.com/pengbin9472/ggbond/main/docs/ADMIN_PAYMENT_INTEGRATION_API.md"
                  target="_blank"
                  rel="noopener noreferrer"
...
const paymentGuideHref = computed(() =>
  locale.value.startsWith("zh")
    ? "https://github.com/pengbin9472/ggbond/blob/main/docs/PAYMENT_CN.md"
    : "https://github.com/pengbin9472/ggbond/blob/main/docs/PAYMENT.md",
);

const paymentMethodsHref = computed(() =>
  locale.value.startsWith("zh")
    ? "https://github.com/pengbin9472/ggbond/blob/main/docs/PAYMENT_CN.md#支持的支付方式"
    : "https://github.com/pengbin9472/ggbond/blob/main/docs/PAYMENT.md#supported-payment-methods",
);
...
function resetAffiliateCode(entry: AffiliateAdminEntry) {
  openAffiliateConfirm(
    t("common.reset"),
    t("admin.settings.features.affiliate.customUsers.resetConfirm"),
    t("common.reset"),
...
function clearAffiliateUser(entry: AffiliateAdminEntry) {
  openAffiliateConfirm(
    t("common.confirm"),
    t("admin.settings.features.affiliate.customUsers.clearConfirm"),
    t("common.delete"),
